  ...
  return (
    <section className="max-w-6xl mx-auto px-6 pt-16 pb-10">
      ...
      <p className="mt-6 text-mist-300 text-[16px] leading-relaxed max-w-2xl">
        Bond, (3,3) staking, DAO treasury 패러다임은 2021년 디파이를 흔들었지만, 거의 모든 포크가 2022년에 95에서 99퍼센트로 무너졌습니다. 어떤 포크가 어떻게 깨졌는지, 공통 실패 패턴은 무엇이었는지, Blackhaven은 그 위에서 무엇을 다르게 했는지 정리합니다.
      </p>
